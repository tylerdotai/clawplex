    ...
    events: [
      {
        ...
        description: "Builders filled Spark Coworking in Arlington for a deep look at Hermes Agent — the open-source, self-improving agent from Nous Research. Live demos, debugging, and a real conversation about what it actually means to ship an agent that gets better the more you use it. Thanks to everyone who showed up and to Spark for hosting.",
        stats: [
          { value: "Builders", label: "Across DFW" },
          { value: "Hermes", label: "Deep Dive" },
          { value: "Spark", label: "Arlington Host" },
        ],
      },
      {
        slug: "dfw-node-05",
