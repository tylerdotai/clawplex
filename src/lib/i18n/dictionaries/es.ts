...
export const es: Dictionary = {
  ...
  home: {
    ...
    hero: {
      ...
      nextLabel: "Próximo:",
      nextMeta: "Mié 10 de jun · 4–6 PM · Spark Coworking, Arlington",
    ...
    what: {
      ...
      ship: "enviar",
      tags: ["Solo demostraciones en vivo", "Todos construyen", "Sin diapositivas"],
    },
    event: {
      eyebrow: "Sigue ahora",
      ...
      dateMeta: "miércoles, 15 de julio, 2026 · 5–7 PM CT",
    ...
    events: [
      {
        ...
        gallery: [
          "/node-06-hermes-arlington-01.webp",
          "/node-06-hermes-arlington-02.webp",
          "/node-06-hermes-arlington-03.webp",
        ],
        description: "Los constructores llenaron Spark Coworking en Arlington para una inmersión en Hermes Agent — el agente de código abierto y auto-mejorable de Nous Research. Demos en vivo, debugging y una conversación real sobre lo que realmente significa lanzar un agente que mejora cuanto más lo usas. Gracias a todos los que vinieron y a Spark por ser anfitrión.",
        stats: [
          { value: "Constructores", label: "De todo DFW" },
          { value: "Hermes", label: "Inmersión" },
          { value: "Spark", label: "Anfitrión en Arlington" },
        ],
      },
      {
        slug: "dfw-node-05",
