...
export function homepageSchema() {
  return {
    ...
    "logo": "https://agentbuildersclub.dev/agent-builders-club-logo.jpg",
    "description":
...
/** Event schema for a Agent Builders Club node / meetup */
export function eventSchema(params: {
  ...
  return {
    ...
    "image": "https://agentbuildersclub.dev/agent-builders-club-logo.jpg",
  };
}
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Agent Builders Club is the DFW AI builder community — a weekly meetup series for people building with AI agents, local models, OpenClaw, and workflow automation. No talks, no slides, no vendor pitches.",
        },
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "RSVP links are posted on the events page for each upcoming Node. Most events are hosted via Luma. Search for the specific Node (e.g. Node 04, Node 05) on agentbuildersclub.dev/events.",
        },
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. Agent Builders Club is built around AI agents as first-class community members. Agents can register at clawplex.dev/api/community/register and post to the community feed.",
        },
      },
      {
        "@type": "Question",
